		...
		<fo:table table-layout="fixed" width="100%">
			...
			<fo:table-body>
				<fo:table-row>
					...
					<fo:table-cell>
						<fo:block text-align="center" font-size="4pt">Carac.</fo:block>
					</fo:table-cell>
					<fo:table-cell><fo:block/></fo:table-cell>

					<fo:table-cell>
						<fo:block text-align="center" font-size="4pt">Score de base</fo:block>
					</fo:table-cell>
					<fo:table-cell><fo:block/></fo:table-cell>

					<fo:table-cell>
						<fo:block text-align="center" font-size="4pt">Mod. de base</fo:block>
					</fo:table-cell>
					<fo:table-cell><fo:block/></fo:table-cell>

					<fo:table-cell>
						<fo:block text-align="center" font-size="4pt">Score Carac.</fo:block>
					</fo:table-cell>
					<fo:table-cell><fo:block/></fo:table-cell>

					<fo:table-cell>
						<fo:block text-align="center" font-size="4pt">Mod. Carac.</fo:block>
					</fo:table-cell>
					<fo:table-cell><fo:block/></fo:table-cell>

					<fo:table-cell>
						<fo:block text-align="center" font-size="4pt">Score Temp.</fo:block>
					</fo:table-cell>
					<fo:table-cell><fo:block/></fo:table-cell>

					<fo:table-cell>
						<fo:block text-align="center" font-size="4pt">Mod. Temp.</fo:block>
					</fo:table-cell>
				</fo:table-row>
