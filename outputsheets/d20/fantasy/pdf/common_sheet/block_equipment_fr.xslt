				...
				<fo:table-header>
					<fo:table-row>
						...
						<fo:table-cell number-columns-spanned="5">
							...
							<fo:block font-size="9pt">Equipement</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row>
											<xsl:message>Test</xsl:message>
						...
						<fo:table-cell>
							<fo:block font-size="7pt">Objet</fo:block>
						</fo:table-cell>
						<fo:table-cell>
							<fo:block font-size="7pt">Localisation</fo:block>
						</fo:table-cell>
						<fo:table-cell>
							<fo:block font-size="7pt">Qté</fo:block>
						</fo:table-cell>
						<fo:table-cell number-columns-spanned="2">
							<fo:block font-size="7pt">Pds / Coût</fo:block>
						</fo:table-cell>
				...
				<fo:table-header>
					<fo:table-row keep-with-next.within-column="always">
						...
						<fo:table-cell padding-top="1pt">
							...
							<fo:block font-size="9pt">Monnaie</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-header>
				<fo:table-footer>
				...
				<fo:table-header>
					<fo:table-row keep-with-next.within-column="always">
						...
						<fo:table-cell padding-top="1pt">
							...
							<fo:block font-size="9pt">Magique</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-header>
				<fo:table-body>
